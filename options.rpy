...
define config.name = _("Novel by Schrdinger the Cat")
...
define build.name = "NovelbySchrdingertheCat"
...
define config.save_directory = "NovelbySchrdingertheCat-1669819865"
